...
void InitStateFromHistory()
{
   ...
   for(int i = hb-2*InpPivotLength-1; i >= 2; i--)
   {
      ...
      // v2.24: measure retracement from the impulse extreme. For a
      // bullish swing, 0.35 means 35% down from swing_high; for a
      // bearish swing, it means 35% up from swing_low.
...
int OnInit()
{
   ...
   Print("ATS EA v2.24 | Lot=",InpFixedLot," BE=",InpBEPips,"p Trail@",InpTrailLevel1Pips,"p->",InpTrailLevel1LockPips,"p TP=",InpTPPips,"p");
