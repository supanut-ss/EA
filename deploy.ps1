...
# Keep IIS/ANCM stdout logging disabled on the shared production host. This
# avoids continuously creating host-side stdout files; application-level
# logging and Activity Log ingestion remain unchanged.
$aspNetCoreNode.SetAttribute("stdoutLogEnabled", "false")
Write-Host "  -> Set stdoutLogEnabled=false" -ForegroundColor Gray
